...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class Table implements org.apache.thrift.TBase<Table, Table._Fields>, java.io.Serializable, Cloneable, Comparable<Table> {
  ...
  public int compareTo(Table other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRetention()).compareTo(other.isSetRetention());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRetention()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetViewExpandedText()).compareTo(other.isSetViewExpandedText());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetViewExpandedText()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTemporary()).compareTo(other.isSetTemporary());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTemporary()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRewriteEnabled()).compareTo(other.isSetRewriteEnabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRewriteEnabled()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCreationMetadata()).compareTo(other.isSetCreationMetadata());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCreationMetadata()) {
